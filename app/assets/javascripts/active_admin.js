...
(function () {
    ...
    var basic_tag_whitelist = /^(<\/?(table|thead|tr|th|tbody|td|b|blockquote|code|del|dd|dl|dt|em|h1|h2|h3|h4|h5|h6|i|kbd|li|ol|p|pre|s|sup|sub|strong|strike|ul)>|<(br|hr)\s?\/?>)$/i;
